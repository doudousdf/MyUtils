package utils.wzl.com.utilslibrary.permission;
...
public class PermissionHelper {
	...
	public PermissionHelper(Activity activity, PermissionModel[] permissionModel) {
		mActivity = activity;
		mPermissionModels = permissionModel;
	}
